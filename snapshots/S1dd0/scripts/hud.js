...
for (let Index = 0; Index < Elements.length; Index++) {
    ...
    DescriptionLabel.style.right = "50px";
    ...
    ElementIcon.src = (Element.Radioactive === true || Element.Light === true) ? "../images/ElementIcons/radioactive.png" : `../images/ElementIcons/${Element.Type.toLowerCase()}.png`;
    ElementIcon.style.marginLeft = "16px";
    ElementIcon.style.height = "24px";
    ElementIcon.style.aspectRatio = "1 / 1";
    DescriptionLabel.appendChild(ElementIcon);

    ElementDiv.addEventListener("mouseenter", function() {
        this.style.height = "40px";
        DescriptionLabel.style.opacity = "1";

        document.body.setAttribute("selected", this.id);
    ...
    ElementDiv.addEventListener("mouseleave", function() {
        const DescriptionLabel = this.querySelector("#DescriptionLabel");
        if (DescriptionLabel) {
            DescriptionLabel.style.opacity = "0";
        }
    });
