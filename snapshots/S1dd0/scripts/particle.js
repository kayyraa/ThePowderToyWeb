                            ...
                            if (OtherParticle !== Particle && !IgnoreList.has(OtherParticle)) {
                                ...
                                if (OtherType === "Powder" || OtherType === "Solid" || OtherType === "Liquid") {
                                    ...
                                    if (
                                        ...
                                        if (OtherType === "Powder" || OtherType === "Liquid" || OtherType === "Solid") {
                                            const DisplacementX = ParticleRect.left - OtherRect.right;
                                            const DisplacementY = ParticleRect.top - OtherRect.bottom;
